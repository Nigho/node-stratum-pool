...
exports.bech32ToScript = function(addr){

    var hrp = "mc";
    var ret = segwit_addr.decode(hrp, addr);
    if (ret === null) {
        hrp = "tmc";
        ret = segwit_addr.decode(hrp, addr);
    }
    
    return segwit_scriptpubkey(ret.version, ret.program);
};
